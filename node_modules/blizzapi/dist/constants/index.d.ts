declare const CONSTANTS: {
    ...
    OAUTH_AUTHORIZE_URIS: Readonly<import("..").RegionIdProperties<string>>;
    OAUTH_TOKEN_URIS: Readonly<import("..").RegionIdProperties<string>>;
    OAUTH_CHECK_TOKEN_URIS: Readonly<import("..").RegionIdProperties<string>>;
};
